function score = accuracy_A(true_labels, cluster_labels)
%ACCURACY_A Compute clustering accuracy using the true and cluster labels and
%accuracy_A function is the accelerated version of accuracy function. 
