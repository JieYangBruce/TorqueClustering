function [Idx,Idx_with_noise,cutnum,cutlink_ori,p,firstlayer_loc_onsortp,mass,R,cutlinkpower_all] = TorqueClustering_kdtree(data,K,isnoise,isfig)
% input: data: dataset of n x m, where n and m mean the number of total data samples and dimensions respectively;
...
[~,ic,~] = unique(current_labels,'first');%%or last
