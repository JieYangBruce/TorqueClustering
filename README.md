...
You can call `TORC(ALL_DM, K, isnoise, isfig)` in exactly the same way as `TorqueClustering`. When writing about this method, please refer to it as *Torque Clustering (TORC)*.
